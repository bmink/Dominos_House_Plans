...
There's also a [Cutlist.pdf](Cutlist.pdf) which shows how the panels are laid out on a 4' x 8' sheet (cut into three 32" sections which is how I usually handle sheet goods in my small shop). I used [Cutlist Optimizer](https://www.cutlistoptimizer.com) to create the cutlist.
